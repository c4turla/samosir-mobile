    ...
    <header class="bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 flex-shrink-0 safe-area-top z-10 transition-colors">
      <div class="px-5 h-16 flex items-center justify-between">
        <div class="flex items-center space-x-2.5">
          <img src="/logobaru.webp" alt="SAMOSIR Logo" class="w-8 h-8 object-contain" />
          <div class="flex flex-col justify-center">
            <h1 class="text-sm font-bold text-gray-800 dark:text-gray-100 leading-tight">SAMOSIR</h1>
            <span class="text-[9px] text-gray-400 dark:text-gray-500 font-bold leading-none mt-0.5">versi 3.0</span>
          </div>
        </div>
        <div class="flex items-center space-x-4">
          <router-link to="/home/notifications" class="relative text-gray-400 dark:text-gray-500 hover:text-primary-600 dark:hover:text-primary-400">
            <Bell class="w-6 h-6" />
            <span v-if="unreadCount > 0" class="absolute -top-1 -right-1 bg-red-500 text-white text-[8px] font-extrabold rounded-full px-1 min-w-[16px] h-4 flex items-center justify-center border border-white dark:border-slate-900">
